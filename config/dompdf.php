...
return [
'font_dir' => storage_path('fonts/'),        // Local para salvar fontes personalizadas
'font_cache' => storage_path('fonts/'),      // Cache de fontes
'isRemoteEnabled' => true,                   // Habilita recursos remotos
'chroot' => realpath(base_path()),           // Diretório base seguro
